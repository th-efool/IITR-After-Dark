...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    public class AeroplaneAudio : MonoBehaviour
    {
        ...
        public AudioSource m_EngineSoundSource;  // Reference to the AudioSource for the engine.
        public AudioSource m_WindSoundSource;    // Reference to the AudioSource for the wind.
